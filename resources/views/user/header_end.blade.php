                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ url('proxy-image/logo/'. str_replace(['../public/upload/logo/','public/upload/logo/'], '', session('company_logo') )) }}" alt="Header Avatar">

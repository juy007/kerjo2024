                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr valign="middle">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img src="{{ url('proxy-image/avatar/'. str_replace(['../public/upload/avatar/', './public/upload/avatar/', 'public/upload/avatar/'], '', $applications['user']['avatar'] )) }}" class="avatar-md rounded-circle" alt="img" />
                                    ...
                                    <td><a href="{{ url('proxy-cv/' . str_replace(['../public/upload/cv/','./public/upload/cv/','public/upload/cv/'], '', $applications['cv']['link'])) }}">Download</a></td>
                                    <td>

                                                    ...
                                                    <div class="screen1">
                                                        <div class="containerx">
                                                            ...
                                                            <div class="job-header">
                                                                ...
                                                                <img alt="Company Logo" height="30" src="{{ url('proxy-image/logo/'. str_replace(['../public/upload/logo/', './public/upload/avatar/', 'public/upload/avatar/'], '', session('company_logo') )) }}" width="50" />
                                                                <div>
